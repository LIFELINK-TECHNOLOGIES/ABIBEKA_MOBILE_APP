  ...
  return (
    <View style={s.postWrap}>
      <View style={s.postTop}>
        ...
        <View style={{ flex: 1, gap: 3 }}>
          <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
            ...
            {post.trending && (
              <View style={s.trendBadge}><Text style={s.trendText}>🔥</Text></View>
            )}
          </View>
      ...
      <View style={s.postActions}>
        ...
        <View style={{ flex: 1 }} />
        <Text style={[s.signalText, { color: score > 30 ? B.accent : score > 10 ? B.muted : B.muted2 }]}>
          {score > 0 ? "+" : ""}{score}
        </Text>
      </View>
  ...
  return (
    <Animated.View style={[s.sheet, { transform: [{ translateY: slide }] }]}>
      ...
      <View style={s.sheetHeader}>
        <View style={s.sheetAvatar}><Text style={{ fontSize: 18 }}>🦊</Text></View>
        <View style={{ flex: 1 }}>
      ...
      <View style={s.privacyRow}>
        ...
        <Text style={s.privacyText}>Your Anon ID is shown, never your name or identity.</Text>
      </View>
      ...
      <View style={s.filterBar}>
        {(["all", "trending", "recent"] as FilterType[]).map(tab => (
          <Pressable
            ...
            style={[s.filterBtn, filter === tab && { borderBottomWidth: 2, borderBottomColor: B.primary }]}
          >
            <Text style={[s.filterText, filter === tab && { color: B.text, fontWeight: "700" }]}>
              {tab === "all" ? "All" : tab === "trending" ? "🔥 Trending" : "Recent"}
            </Text>
          </Pressable>
        ))}
      </View>
...
const s = StyleSheet.create({
  ...
  avatar:         { width: 38, height: 38, borderRadius: 12, backgroundColor: B.cardRaised, borderWidth: 1, borderColor: B.border, alignItems: "center", justifyContent: "center" },
  moodTag:        { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 9, paddingVertical: 4, borderRadius: 20, borderWidth: 1 },
  moodDot:        { width: 5, height: 5, borderRadius: 3 },
  moodTagText:    { fontSize: 11, fontWeight: "700" },
  trendBadge:     { width: 22, height: 22, borderRadius: 7, backgroundColor: B.amber + "15", alignItems: "center", justifyContent: "center" },
  ...
  voteBtn:        { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 20, borderWidth: 1, borderColor: B.border, backgroundColor: "rgba(255,255,255,0.02)" },
  ...
  filterBar:      { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: B.border },
  filterBtn:      { flex: 1, paddingVertical: 12, alignItems: "center" },
  filterText:     { fontSize: 13, color: B.muted },
  fab:            { position: "absolute", bottom: 28, right: 20, width: 54, height: 54, borderRadius: 17, backgroundColor: B.primary, alignItems: "center", justifyContent: "center", zIndex: 99, shadowColor: B.primary, shadowRadius: 16, shadowOpacity: 0.45, shadowOffset: { width: 0, height: 4 } },
  ...
  handle:         { width: 36, height: 4, borderRadius: 2, backgroundColor: "rgba(255,255,255,0.12)", alignSelf: "center", marginBottom: 20 },
  sheetHeader:    { flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 18 },
  sheetAvatar:    { width: 38, height: 38, borderRadius: 12, backgroundColor: B.primary + "20", borderWidth: 1, borderColor: B.primary + "28", alignItems: "center", justifyContent: "center" },
  sheetTitle:     { fontSize: 15, fontWeight: "800", color: B.text },
  sheetSub:       { fontSize: 11, color: B.muted, marginTop: 2 },
  textWrap:       { backgroundColor: "rgba(255,255,255,0.03)", borderRadius: 14, borderWidth: 1, borderColor: B.border, padding: 14, marginBottom: 18 },
  textInput:      { fontSize: 15, color: B.text, minHeight: 80, textAlignVertical: "top", lineHeight: 23 },
  charCount:      { fontSize: 11, fontWeight: "700", textAlign: "right", marginTop: 6 },
  tagLabel:       { fontSize: 11, fontWeight: "700", color: B.muted2, letterSpacing: 0.8, textTransform: "uppercase", marginBottom: 10 },
  tagChip:        { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: B.border, backgroundColor: "rgba(255,255,255,0.03)" },
  tagChipText:    { fontSize: 13, color: B.muted },
  privacyRow:     { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, backgroundColor: "rgba(255,255,255,0.03)", borderWidth: 1, borderColor: B.border, marginBottom: 16 },
  privacyText:    { fontSize: 12, color: B.muted, flex: 1 },
  postHint:       { fontSize: 12, color: B.amber, textAlign: "center", marginBottom: 10 },
  postBtn:        { height: 52, borderRadius: 15, backgroundColor: B.primary, alignItems: "center", justifyContent: "center", shadowColor: B.primary, shadowRadius: 14, shadowOpacity: 0.4, shadowOffset: { width: 0, height: 3 } },
  postBtnDisabled:{ height: 52, borderRadius: 15, backgroundColor: B.primary, alignItems: "center", justifyContent: "center", opacity: 0.35 },
