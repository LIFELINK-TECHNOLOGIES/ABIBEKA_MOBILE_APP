...
export const INITIAL_POSTS: Post[] = [
  ...
  },
  {
    ...
    avatar: "🐺",
    content:
      "Finally feel like I'm making progress after weeks of feeling stuck. Shipped something I'm proud of today. Small wins matter more than I realised.",
    moodTag: "hopeful",
    tagColor: B.accent,
    upvotes: 82,
    downvotes: 1,
  ...
  },
  {
    ...
    avatar: "🦁",
    content:
      "Communication gaps between teams are causing so much unnecessary stress. We need better systems urgently, not more meetings.",
    moodTag: "stressed",
    tagColor: B.amber,
    upvotes: 61,
    downvotes: 8,
  ...
  },
  {
    ...
    avatar: "🐻",
    content:
      "Been working late every single day for the past month. Management keeps piling on more without acknowledging anyone's limits. This is unsustainable.",
    moodTag: "overwhelmed",
    tagColor: B.rose,
    upvotes: 94,
    downvotes: 2,
  ...
  },
  {
    ...
    avatar: "🦋",
    content:
      "Had a genuinely supportive 1:1 with my lead today. It made a real difference to feel heard. We need more of this in our culture.",
    moodTag: "grateful",
    tagColor: B.primary,
    upvotes: 53,
    downvotes: 0,
  ...
  },
  {
    ...
    avatar: "🦅",
    content:
      "The workload distribution here is deeply unequal. Some people are drowning while others coast. This needs to be addressed openly.",
    moodTag: "stressed",
    tagColor: B.amber,
    upvotes: 71,
    downvotes: 5,
